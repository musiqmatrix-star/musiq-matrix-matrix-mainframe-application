    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden">
      ...
      <section className="py-24 md:py-32">
        <div className="container">
          <StorySection
            ...
            imageAlt="The Maverick's origin - coding in the shadows"
            accentColor="#FFB800"
            index={0}
          />
        </div>
      ...
      >
        <div className="container">
          <StorySection
            subtitle="CHAPTER II"
            title="THE FREQUENCY CODE"
            content={[
              "The breakthrough came at 3:47 AM on a night like any other—except it wasn't. After years of research, The Maverick finally cracked it: the algorithm that bridges human consciousness with pure frequency.",
              "This wasn't just music theory. This was the discovery that sound frequencies could be precisely engineered to evoke specific emotional states, unlock creative potential, and transform the listener's experience at a fundamental level.",
              "The Code, as it came to be known, became the foundation of everything that followed. A mathematical framework so elegant, so powerful, that it would change the way humanity experiences sound forever.",
            ]}
            image="/images/frequency-visualization.jpg"
            imageAlt="Frequency visualization and the code"
            reverse={true}
            accentColor="#00F0FF"
            index={1}
          />
      ...
      <section className="py-24 md:py-32">
        <div className="container">
          ...
          >
            <p className="font-display text-sm tracking-[0.3em] text-[#FF00AA] mb-3">
              THE JOURNEY
            </p>
            <h2 className="font-display font-bold text-3xl md:text-4xl tracking-wider text-white">
              FROM VISION TO <span className="text-gradient-magenta">REVOLUTION</span>
            </h2>
          </motion.div>

          <div className="max-w-2xl mx-auto">
            {milestones.map((milestone, index) => (
              <TimelineMilestone key={milestone.title} {...milestone} index={index} />
            ))}
          </div>
        </div>
      </section>
      ...
      >
        <div className="container">
          <StorySection
            ...
            title="THE VISION"
            content={[
              "MUSIQ MATRIX is more than a platform—it's a movement. A global community of frequency seekers, sonic architects, and consciousness explorers united by a single purpose: to unlock the transformative power of sound.",
              "The Maverick's vision extends beyond technology. It's about empowerment. About giving every creator, every listener, every seeker the tools to experience music at its most profound level.",
              "This is just the beginning. The Matrix continues to evolve, expand, and transform. And you're invited to be part of the revolution.",
            ]}
            image="/images/community-vision.jpg"
            imageAlt="The MUSIQ MATRIX community vision"
            accentColor="#7B2CBF"
            index={2}
          />
        </div>
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background: `
                radial-gradient(ellipse at 30% 50%, rgba(255, 184, 0, 0.1) 0%, transparent 50%),
        ...
        <div className="container relative z-10">
          ...
          >
            <div className="text-6xl text-[#FFB800]/30 mb-6">"</div>
            <blockquote className="font-display text-2xl md:text-3xl lg:text-4xl tracking-wide text-white leading-relaxed mb-8">
              The algorithm is a script. But{" "}
              <span className="text-gradient-gold">I am the code</span>. And so are you.
              We are all frequencies waiting to be{" "}
              <span className="text-gradient-cyan">unlocked</span>.
            </blockquote>
            <p className="font-display text-lg tracking-wider text-[#FFB800]">
              — THE MAVERICK
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-24 md:py-32">
        <div className="container">
          ...
          >
            <h2 className="font-display font-bold text-3xl md:text-4xl tracking-wider text-white mb-6">
              READY TO <span className="text-gradient-gold">ENTER THE MATRIX</span>?
            </h2>
            <p className="text-white/60 max-w-xl mx-auto mb-10">
              Join thousands of frequency seekers who have already begun their
              transformation. The code awaits.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/#conversion">
                <Button className="font-display tracking-wider bg-gradient-to-r from-[#FFB800] to-[#FFC933] text-black hover:from-[#FFC933] hover:to-[#FFD966] px-8 py-6 glow-gold">
                  JOIN THE REVOLUTION
              ...
              <Link href="/">
                <Button
                  variant="outline"
                  className="font-display tracking-wider border-white/20 text-white hover:bg-white/5 px-8 py-6"
                >
                  BACK TO HOME
                </Button>
              </Link>
